 ...
 */
@Controller
public class UrgentHelpSubscribe {

	@Autowired
	private SessionObject sessionObject;

	@RequestMapping(value = "urgentHelpSubscribe", method = RequestMethod.POST)
	public ModelAndView event(HttpServletRequest request, @RequestParam String urgentHelp) {
		...
		if (urgentHelp.equalsIgnoreCase("Unsubscribed")) {
			urgentHelp = "Subscribed";
			user.setUrgentHelp(true);

		} else if (urgentHelp.equalsIgnoreCase("subscribed")) {
			urgentHelp = "Unsubscribed";
			user.setUrgentHelp(false);
		}
		...
		mv.addObject("urgentHelp", urgentHelp);
		return mv;
	}
}
